...
export const rooms: { [roomId: string]: Room } = {
    ...
    yoshinoya: {
        ...
        scale: 2.26,
        size: { x: 12, y: 14 },
        originCoordinates: { x: -313, y: 541 },
        spawnPoint: "spawn",
        backgroundImageUrl: "rooms/yoshinoya/yoshinoya.svg",
        backgroundColor: "#c0c0c0",
        objects: [

            { x: 0, y: 0, url: "left-wall.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 0, y: 0, url: "small-wallish-thing.svg", scale: 1, xOffset: 3, yOffset: -4 },
            { x: 0, y: 0, url: "wall-with-squid.svg", scale: 1, xOffset: 3, yOffset: -4 },



            // right table
            { x: 5 + 4, y: 3 + 6, url: "counter-left-corner.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 5 + 4, y: 4 + 6, url: "counter-middle.svg", scale: 1, xOffset: 3, yOffset: -4 },
            { x: 5 + 4, y: 5 + 6, url: "counter-right-corner.svg", scale: 1, xOffset: 3, yOffset: -4 },
            { x: 1 + 4, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 0 + 4, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 2 + 4, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 3 + 4, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 4 + 4, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 0 + 4, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 1 + 4, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 2 + 4, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 3 + 4, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 4 + 4, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            // left table
            { x: 0 + 4, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 1 + 4, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 2 + 4, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 3 + 4, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 4 + 4, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 0 + 4, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 1 + 4, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 2 + 4, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 3 + 4, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 4 + 4, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 5 + 4, y: 4, url: "counter-middle.svg", scale: 1, xOffset: 1, yOffset: -1 },
            { x: 5 + 4, y: 5, url: "counter-right-corner.svg", scale: 1, xOffset: 2, yOffset: -1 },
            { x: 5 + 4, y: 3, url: "counter-left-corner.svg", scale: 1, xOffset: 1, yOffset: -1 },
        ],
        sit: [
            // left table
            { x: 0 + 4, y: 2 },
