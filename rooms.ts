...
export const rooms: { [roomId: string]: Room } = {
    ...
    yoshinoya: {
        ...
        objects: [
            // right table
            { x: 5, y: 3 + 6, url: "counter-left-corner.svg", scale: 1, xOffset: 2, yOffset: -2 },
            { x: 5, y: 4 + 6, url: "counter-middle.svg", scale: 1, xOffset: 3, yOffset: -2 },
            { x: 5, y: 5 + 6, url: "counter-right-corner.svg", scale: 1, xOffset: 4, yOffset: -3 },
            { x: 1, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 0, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 2, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 3, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 4, y: 5 + 6, url: "counter-right.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 0, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 1, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 2, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 3, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            { x: 4, y: 3 + 6, url: "counter-left.svg", scale: 1, xOffset: 2, yOffset: -3 },
            // left table
            { x: 0, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 1, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 2, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 3, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 4, y: 5, url: "counter-right.svg", scale: 1, xOffset: 0, yOffset: -1 },
            { x: 0, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 1, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 2, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 3, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 4, y: 3, url: "counter-left.svg", scale: 1, xOffset: 0, yOffset: -2 },
            { x: 5, y: 4, url: "counter-middle.svg", scale: 1, xOffset: 1, yOffset: -1 },
            { x: 5, y: 5, url: "counter-right-corner.svg", scale: 1, xOffset: 2, yOffset: -1 },
            { x: 5, y: 3, url: "counter-left-corner.svg", scale: 1, xOffset: 1, yOffset: -1 },
        ],
        sit: [
            { x: 0, y: 2 },
            { x: 1, y: 2 },
